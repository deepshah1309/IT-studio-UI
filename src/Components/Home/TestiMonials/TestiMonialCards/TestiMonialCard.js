    ...
    <div className="testimonialcard">
      ...
      <div className="testimonial_imagepart_mobileView">
        <div className="image_testimonial_mobileview">
          <img
            src={data[step].images.image1}
            alt="people"
            className="mobileview_testimonial_circle"
          />
        </div>
      </div>
      <div className="testimonials_imagepart">
        <div className="test_image">
          <>
            <img
              src={
                step <= data.length - 3 - 1
                  ? data[step + 1].images.image1
                  : data[step - 1].images.image1
              }
              alt="people"
            ...
            <img
              src={
                step <= data.length - 4
                  ...
                  : step === data.length - 3
                  ? data[step - 3].images.image1
                  : step === data.length - 2 || step === data.length - 1
                  ? data[step - 3].images.image1
                  : ""
              }
              alt="people"
      ...
      <div className="testimonials_contentpart">
        <div className="testimonialcontent_head">{data[step].name}</div>
        <div className="testimonialcontent_text">{data[step].description}</div>
      </div>
      {step + 1 >= data.length ? (
        ""
      ) : (
        <div
          className="right_arrow_test"
          onClick={() => {
            setStep(step + 1);
          }}
        >
